        ...
        <div className="rounded-2xl bg-white/[0.03] border border-white/5 p-6 space-y-5">
          <div className="flex items-center justify-between text-center">
            <div className="flex-1">
              <div className="w-12 h-12 mx-auto rounded-lg flex items-center justify-center text-sm font-bold mb-1" style={{ background: home?.primary_color, color: home?.secondary_color }}>{home?.short_name?.slice(0,3)}</div>
              <div className="text-xs text-slate-400">{home?.name}</div>
            </div>
            <div className="text-xs text-slate-500 uppercase tracking-wider">vs</div>
            <div className="flex-1">
              <div className="w-12 h-12 mx-auto rounded-lg flex items-center justify-center text-sm font-bold mb-1" style={{ background: away?.primary_color, color: away?.secondary_color }}>{away?.short_name?.slice(0,3)}</div>
              <div className="text-xs text-slate-400">{away?.name}</div>
            </div>
          </div>
